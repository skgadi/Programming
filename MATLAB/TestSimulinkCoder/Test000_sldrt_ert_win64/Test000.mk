...
MODEL                := Test000
MODULES              := Test000_data.c Test000_tgtconn.c
MAKEFILE             := Test000.mk
...
TID01EQ              := 0
NCSTATES             := 0
BUILDARGS            :=  ISPROTECTINGMODEL=NOTPROTECTING GENERATE_ERT_S_FUNCTION=0 INCLUDE_MDL_TERMINATE_FCN=1 COMBINE_OUTPUT_UPDATE_FCNS=0 MAT_FILE=0 MULTI_INSTANCE_CODE=0 INTEGER_CODE=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 TMW_EXTMODE_TESTING=0 OPTS="-DTGTCONN -DON_TARGET_WAIT_FOR_START=1"
MULTITASKING         := 0
EXT_MODE             := 1
EXTMODE_TRANSPORT    := 0
...
#
MODELLIB                  := Test000lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Test000_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/GitHub/Programming/MATLAB/TestSimulinkCoder;$(MATLAB_ROOT)/simulink/include/sf_runtime;D:/GitHub/Programming/MATLAB/TestSimulinkCoder/Test000_sldrt_ert_win64
