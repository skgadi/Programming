...
MODEL                := sldrtex_controller
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sldrtex_controller_data.c sldrtex_controller_tgtconn.c
MAKEFILE             := sldrtex_controller.mk
...
#
MODELLIB                  := sldrtex_controllerlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sldrtex_controller_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/GitHub/Programming/MATLAB;$(MATLAB_ROOT)/simulink/include/sf_runtime;D:/GitHub/Programming/MATLAB/sldrtex_controller_sldrt_win64;$(MATLAB_ROOT)/toolbox/sldrt/sldrtexamples;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
