###########################################################################
## Makefile generated for Simulink model 'rtwdemo_slcustcode'. 
## 
## Makefile     : rtwdemo_slcustcode.mk
## Generated on : Mon Jul 10 18:52:59 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/rtwdemo_slcustcode.exe
...
PRODUCT_NAME              = rtwdemo_slcustcode
MAKEFILE                  = rtwdemo_slcustcode.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = rtwdemo_slcustcode_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = rtwdemo_slcustcode_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/rtwdemo_slcustcode.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/rtwdemo_slcustcode_grt_rtw -I$(MATLAB_ROOT)/toolbox/rtw/rtwdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/grt/_sharedutils
...
DEFINES_STANDARD = -DMODEL=rtwdemo_slcustcode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/rtwdemo_slcustcode_grt_rtw/rtwdemo_slcustcode.c
...
%.obj : $(START_DIR)/rtwdemo_slcustcode_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
