...
## Generated on : Mon Jul 10 19:11:38 2017
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/GitHub/Programming/MATLAB
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/rtwdemo_secondOrderSystem_grt_rtw -I$(MATLAB_ROOT)/toolbox/rtw/rtwdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(START_DIR)/slprj/grt/_sharedutils
...
DEFINES_BUILD_ARGS = -DEXT_MODE=1 -DMAT_FILE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0
...
SRCS = $(START_DIR)/rtwdemo_secondOrderSystem_grt_rtw/rtwdemo_secondOrderSystem.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = rtwdemo_secondOrderSystem.obj rtiostream_interface.obj rtiostream_tcpip.obj ext_svr.obj updown.obj ext_work.obj rtiostream_utils.obj
