...
void rtwdemo_secondOrderSystem_step(void)
{
  ...
  if (rtmIsMajorTimeStep(rtwdemo_secondOrderSystem_M)) {
    ...
    {                                  /* Sample time: [0.0s, 0.0s] */
      rtExtModeUpload(0, rtwdemo_secondOrderSystem_M->Timing.t[0]);
    }

    if (rtmIsMajorTimeStep(rtwdemo_secondOrderSystem_M)) {/* Sample time: [0.001s, 0.0s] */
      rtExtModeUpload(1, (((rtwdemo_secondOrderSystem_M->Timing.clockTick1+
...
void rtwdemo_secondOrderSystem_initialize(void)
{
  ...
  /* External mode info */
  rtwdemo_secondOrderSystem_M->Sizes.checksums[0] = (3455005830U);
  rtwdemo_secondOrderSystem_M->Sizes.checksums[1] = (175354925U);
  rtwdemo_secondOrderSystem_M->Sizes.checksums[2] = (977218152U);
  rtwdemo_secondOrderSystem_M->Sizes.checksums[3] = (466143811U);
